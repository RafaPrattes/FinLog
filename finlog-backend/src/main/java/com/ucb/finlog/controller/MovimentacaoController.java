...
public class MovimentacaoController {
    ...
    @PutMapping("/{id}")
    public Movimentacao atualizar(@PathVariable Long id, @RequestBody Movimentacao movimentacao, @AuthenticationPrincipal UsuarioAutenticado usuario) {
    return service.atualizar(id, movimentacao, usuario.email());
    }
